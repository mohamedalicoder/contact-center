    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
                <!-- Active Tickets -->
                <div class="overflow-hidden p-6 bg-white rounded-xl border border-gray-100 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105">
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="mb-1 text-sm font-medium text-gray-500">المحادثات النشطة</p>
                            <p class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">{{ $stats['active_chats'] }}</p>
                        </div>
                ...
                <div class="overflow-hidden p-6 bg-white rounded-xl border border-gray-100 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105">
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="mb-1 text-sm font-medium text-gray-500">محادثات اليوم</p>
                            <p class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-400">{{ $todayStats['total_chats'] }}</p>
                            <div class="mt-2 text-sm text-gray-500">
                                <span class="font-medium text-green-600">{{ $todayStats['active_chats'] }}</span> نشط،
                                <span class="font-medium text-blue-600">{{ $todayStats['ended_chats'] }}</span> منتهي
                            </div>
                        </div>
                ...
                <div class="overflow-hidden p-6 bg-white rounded-xl border border-gray-100 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105">
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="mb-1 text-sm font-medium text-gray-500">عدد الموظفين النشطين</p>
                            <p class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-400">{{ $stats['active_employees'] }}</p>
                        </div>
                ...
                <div class="overflow-hidden p-6 bg-white rounded-xl border border-gray-100 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105">
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="mb-1 text-sm font-medium text-gray-500">المحادثات المنتهية</p>
                            <p class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-yellow-400">{{ $stats['ended_chats'] }}</p>
                        </div>
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 lg:grid-cols-2">
                <!-- Call Volume Chart -->
                <div class="overflow-hidden p-6 bg-white rounded-xl border border-gray-100 shadow-lg">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($recentChats as $chat)
                                <tr>
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{{ $chat->user->name }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{{ $chat->agent->name ?? '-' }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{{ $chat->last_message->content ?? '-' }}</td>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{{ $chat->created_at->format('Y-m-d H:i') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
